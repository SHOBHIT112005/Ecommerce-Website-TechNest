...
export default function Product({ id, name, price, description, picture }: ProductProps) {
  return (
    <Link href={"/product/" + id} className="w-64 shrink-0 hover:border-emerald-300 border border-transparent rounded-xl p-1 flex flex-col transition-colors duration-200">
